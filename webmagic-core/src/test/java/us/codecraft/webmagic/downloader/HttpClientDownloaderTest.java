...
public class HttpClientDownloaderTest {
    ...
    public void test_download_fail() {
        ...
        Page page = httpClientDownloader.download(request, task).getPage();
    ...
    public void test_set_request_cookie() throws Exception {
        ...
        Runner.running(server, new Runnable() {
            ...
            public void run() throws Exception {
                ...
                Page page = httpClientDownloader.download(request, Site.me().toTask()).getPage();
    ...
    public void test_disableCookieManagement() throws Exception {
        ...
        Runner.running(server, new Runnable() {
            ...
            public void run() throws Exception {
                ...
                request.setUrl("http://127.0.0.1:13423");
                request.addCookie("cookie","cookie-webmagic");
                Page page = httpClientDownloader.download(request, Site.me().setDisableCookieManagement(true).toTask()).getPage();
                assertThat(page.getRawText()).isEqualTo("ok");
            }
        });
    }
    ...
    public void test_set_site_header() throws Exception {
        ...
        Runner.running(server, new Runnable() {
            ...
            public void run() throws Exception {
                ...
                Request request = new Request();
                request.setUrl("http://127.0.0.1:13423");
                Page page = httpClientDownloader.download(request, Site.me().addHeader("header","header-webmagic").toTask()).getPage();
                assertThat(page.getRawText()).isEqualTo("ok");
            }
        });
    }
    ...
    public void test_set_site_cookie() throws Exception {
        ...
        Runner.running(server, new Runnable() {
            ...
            public void run() throws Exception {
                ...
                Page page = httpClientDownloader.download(request, site.toTask()).getPage();
                assertThat(page.getRawText()).isEqualTo("ok");
            }
        });
    }
    ...
    public void test_download_set_request_charset() throws Exception {
        ...
        Runner.running(server, new Runnable() {
            ...
            public void run() throws Exception {
                ...
                request.setUrl("http://127.0.0.1:13423/");
                Page page = httpClientDownloader.download(request, Site.me().setCharset("gbk").toTask()).getPage();
                assertThat(page.getCharset()).isEqualTo("utf-8");
            }
        });
    }
