...
public class Request implements Serializable {
    ...
    protected RequestResourceType resourceType = RequestResourceType.HTML;
    ...
    public Request(String url,RequestResourceType resourceType) {
        this.url = url;
    ...
    public static enum RequestResourceType{
        HTML,IMG;
    }
